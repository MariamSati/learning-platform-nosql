...
// Réponse: Une route définit l'URL et la méthode HTTP (GET, POST, etc.), tandis qu'un contrôleur contient la logique métier exécutée lorsqu'une route est appelée.
// Question : Pourquoi séparer la logique métier des routes ?
// Réponse : Séparer la logique métier des routes permet de rendre le code plus modulaire, lisible, réutilisable et facile à maintenir.
